        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-baloo font-size-16">
                    <div class="col">
                        <button type="submit" class="btn btn-danger form-control">Processed To Buy</button>
                    </div>
                    <div class="col">
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    <tr class="font-rale font-size-14">
                        <td>M.R.P:</td>
                        <td><strike>$169.00</strike></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Deal Price</td>
                        <td class="font-size-20 text-danger">$<span>149.00</span><small class="text-dark font-size-12">&nbsp;&nbsp;inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">$20.00</span></td>
                    </tr>
                </table>
                <!-- !Product Price-->
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    <small>Delivery by: Aug 25 - Dec 31</small>
